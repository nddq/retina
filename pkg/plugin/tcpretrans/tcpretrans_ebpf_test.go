...
//
// Requires: root (or CAP_BPF+CAP_SYS_ADMIN), Linux kernel 4.16+.
...
// tcp/tcp_retransmit_skb tracepoint (stable since kernel 4.16).
...
func TestBPFStopAfterInitWithoutStart(t *testing.T) {
	...
	// Start() deliberately not called — isRunning remains false.
